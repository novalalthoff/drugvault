      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-outline card-purple">
            ...
            <!-- form start -->
            <div class="card-body">
              <form id="form" action="{{ route('country.update', $get_data->id_country) }}" method="POST">
                @csrf
                @method('PUT')

                <div class="form-group">
                  <label for="name_country">Nama Negara <span style="color: red">*</span></label>
                  <input type="text" name="name_country" class="form-control" id="name_country" placeholder="Enter Nama Negara" value="{{ $get_data->name_country ?? old('name_country') }}">
                </div>
