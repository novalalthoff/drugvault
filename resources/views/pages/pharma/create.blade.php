      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-outline card-purple">
            ...
            <!-- form start -->
            <div class="card-body">
              <form id="form" action="{{ route('pharma.store') }}" method="POST">
                @csrf

                <div class="form-group">
                  <label for="name_pharma">Nama Farmasi <span style="color: red">*</span></label>
                  <input type="text" name="name_pharma" class="form-control" id="name_pharma" placeholder="Enter Nama Farmasi">
                </div>

                <div class="form-group">
                  <label for="country_id">Negara <span style="color: red">*</span></label>
                  <select class="form-control select2-purple" name="country_id" id="country_id" data-dropdown-css-class="select2-purple" style="width: 100%;"></select>
                </div>

                <div class="form-group">
                  <label for="address_pharma">Alamat</label>
                  <textarea name="address_pharma" class="form-control" id="address_pharma" placeholder="Enter Alamat"></textarea>
                </div>
