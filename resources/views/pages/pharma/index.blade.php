            ...
            <div class="card-header h3 font-weight-light">
              <span class="align-middle">
                ...
                @if (isAccess('create', $get_menu, auth()->user()->role_id))
                  <a href="{{ route('pharma.create') }}" class="btn bg-purple float-right" style="width: 6rem"><i class="fas fa-plus text-sm mr-1"></i> Create</a>
                @endif
              </span>
            </div>
            <!-- /.card-header -->
