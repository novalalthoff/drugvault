      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-outline card-purple">
            ...
            <!-- form start -->
            <div class="card-body">
              <form id="form" action="{{ route('drug.update', $get_data->id_drug) }}" method="POST">
                @csrf
                @method('PUT')

                <div class="form-group">
                  <label for="pharma_id">Farmasi <span style="color: red">*</span></label>
                  <select class="form-control select2-purple" name="pharma_id" id="pharma_id" data-dropdown-css-class="select2-purple" style="width: 100%;">
                    <option value="{{ $get_data->pharma->id_pharma }}" selected>{{ $get_data->pharma->name_pharma }}</option>
                  </select>
                </div>

                <div class="form-group">
                  <label for="name_drug">Nama Obat <span style="color: red">*</span></label>
                  <input type="text" name="name_drug" class="form-control" id="name_drug" placeholder="Enter Nama Obat" value="{{ $get_data->name_drug ?? old('name_drug') }}">
                </div>

                <div class="form-group">
                  <label for="drug_type_id">Tipe <span style="color: red">*</span></label>
                  <select class="form-control select2-purple" name="drug_type_id" id="drug_type_id" data-dropdown-css-class="select2-purple" style="width: 100%;">
                    <option value="{{ $get_data->drug_type->id_drug_type }}" selected>{{ $get_data->drug_type->name_drug_type }}</option>
                  </select>
                </div>

                <div class="form-group">
                  <label for="drug_category_id">Category <span style="color: red">*</span></label>
                  <select class="form-control select2-purple" name="drug_category_id" id="drug_category_id" data-dropdown-css-class="select2-purple" style="width: 100%;">
                    <option value="{{ $get_data->drug_category->id_drug_category }}" selected>{{ $get_data->drug_category->name_drug_category }}</option>
                  </select>
                </div>

                <div class="form-group">
                  <label for="avatar_drug">Image</label>
                  <input type="file" class="form-control" id="avatar_drug" name="avatar_drug" value="{{ $get_data->avatar_drug }}">
                ...
                <div class="form-group">
                  ...
                  <textarea name="note_drug" class="form-control" id="note_drug" placeholder="Catatan Obat">{{ $get_data->note_drug ?? old('note_drug') }}</textarea>
                </div>
