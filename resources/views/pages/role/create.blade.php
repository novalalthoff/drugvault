            ...
            <div class="card-body">
              <form id="form" action="{{ route('role.store') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="code_role" class="form-control" id="code_role" placeholder="Enter Kode Akses">
                </div>

                <div class="form-group">
                  <label for="name_role">Nama Akses <span style="color: red">*</span></label>
                  <input type="text" name="name_role" class="form-control" id="name_role" placeholder="Enter Nama Akses">
                </div>
