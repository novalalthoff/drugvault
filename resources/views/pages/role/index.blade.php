            ...
            <div class="card-header h3 font-weight-light">
              <span class="align-middle">
                ...
                @if (isAccess('create', $get_menu, auth()->user()->role_id))
                  <a href="{{ route('role.create') }}" class="btn bg-purple float-right" style="width: 6rem"><i class="fas fa-plus text-sm mr-1"></i> Create</a>
                @endif
              </span>
            </div>
            <!-- /.card-header -->
              ...
              <table id="datatable" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th>Kode Akses</th>
                    <th>Nama Akses</th>
                    @if (isAccess('privilege', $get_menu, auth()->user()->role_id))
                      <th style="width: 10%" class="text-center">Authorization</th>
                    @endif
