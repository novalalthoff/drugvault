      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-outline card-purple">
            ...
            <!-- form start -->
            <div class="card-body">
              <form id="form" action="{{ route('drug-type.store') }}" method="POST">
                @csrf

                <div class="form-group">
                  <label for="name_drug_type">Tipe Obat <span style="color: red">*</span></label>
                  <input type="text" name="name_drug_type" class="form-control" id="name_drug_type" placeholder="Enter Tipe Obat">
                </div>
