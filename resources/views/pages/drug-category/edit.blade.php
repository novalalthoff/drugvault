      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-outline card-purple">
            ...
            <!-- form start -->
            <div class="card-body">
              <form id="form" action="{{ route('drug-category.update', $get_data->id_drug_category) }}" method="POST">
                @csrf
                @method('PUT')

                <div class="form-group">
                  <label for="name_drug_category">Kategori Obat <span style="color: red">*</span></label>
                  <input type="text" name="name_drug_category" class="form-control" id="name_drug_category" placeholder="Enter Kategori Obat" value="{{ $get_data->name_drug_category ?? old('name_drug_category') }}">
                </div>
          ...
          success: function(response) {
            if (response.status == false) {
              ...
              swalCustom.fire({
                ...
                document.location = "{{ route('drug-category.index') }}";
              });
            }
          },
