              ...
              <form id="form" action="{{ route('menu.store') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2 select2-purple" name="upid_menu" id="upid_menu" data-dropdown-css-class="select2-purple" style="width: 100%;" data-placeholder="Select Status">
                    <option value="0">None ( Jadikan Menu Induk )</option>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="code_menu" class="form-control" id="code_menu" placeholder="ex: MD">
                </div>

                <div class="form-group">
                  <label for="name_menu">Nama Menu <span style="color: red">*</span></label>
                  <input type="text" name="name_menu" class="form-control" id="name_menu" placeholder="Enter Nama Menu">
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="link_menu" class="form-control" id="link_menu">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="icon_menu" class="form-control" id="icon_menu" placeholder="ex: fas fa-user">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="action_menu" class="form-control" id="action_menu" placeholder="ex: create, read, update, delete, detail, list">
